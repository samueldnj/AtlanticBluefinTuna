...
Figure 6. Model predicted spawning stock biomass and recruitment. h is the assumed value of steepness, lnR0 is the log unfished recruitment. Where applicable Inflec. is the biomass position of the inflection (join) point relative to unfished for Hockey-stick stock-recruitment curves. In Beverton-Holt SR plots, the red point is the most recent SSB-Recruitment. 
...
res<-MSYMLE(out,OMI) #-data.frame(1 MSY,2 FMSYap,3 UMSY, 4 BMSY, 5 SSBMSY, 6 BMSY_B0,7 SSBMSY_SSB0, 8RMSY_R0)
