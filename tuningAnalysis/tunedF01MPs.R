# Automatically generated F01 MPs over q grid 

source("Fzero1.R")
# q = 0.2
Fzero1E_q0.368 <- Fzero1E 
formals(Fzero1E_q0.368)$q <- 0.368
...
class(Fzero1E_q0.365) <- 'MP' 


Fzero1W_q0.243 <- Fzero1W 
...
formals(Fzero1W_q0.256)$q <- 0.256
class(Fzero1W_q0.256) <- 'MP' 
